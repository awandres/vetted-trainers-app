...
const socialLinks = [
  { href: "https://www.youtube.com/channel/UCMTekJJglOmXvy3AZGjbQYw", icon: Youtube, label: "YouTube", hoverColor: "hover:bg-red-600" },
  { href: "https://www.instagram.com/vettedtrainers/", icon: Instagram, label: "Instagram", hoverColor: "hover:bg-gradient-to-br hover:from-purple-600 hover:to-pink-500" },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-gray-400 hover:text-[#50BFF4] transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="mailto:Tony@vettedtrainers.com" className="flex items-center gap-3 text-gray-400 hover:text-[#50BFF4] transition-colors">
                  <Mail className="h-5 w-5 flex-shrink-0" />
                  <span>Tony@vettedtrainers.com</span>
                </a>
              </li>
              <li>
                <a href="tel:+12403970240" className="flex items-center gap-3 text-gray-400 hover:text-[#50BFF4] transition-colors">
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-gray-400 text-sm">© {currentYear} Vetted Trainers. All rights reserved.</p>
            <p className="text-gray-400 text-xs">Frederick, Maryland&apos;s Premier Personal Training</p>
          </div>
        </div>
      </div>
    </footer>
