      ...
      <div className="p-4 lg:p-8">
        ...
        <Card className="bg-[#353840] border-[#454850]">
          <CardContent className="py-12 text-center">
            ...
            <p className="text-gray-400 mt-2">The session you're looking for doesn't exist or you don't have access.</p>
            <Link href="/sessions">
    ...
    <div className="p-4 lg:p-8 max-w-4xl mx-auto">
          ...
          <CardContent>
            ...
            {session.sessionValue && (
              <p className="text-sm text-gray-400 mt-1">
                Value: {session.sessionValue} session{parseFloat(session.sessionValue) !== 1 ? "s" : ""}
              </p>
            )}
          </CardContent>
        </Card>
      ...
      <div className="mt-6 flex gap-4">
        <Link href="/sessions" className="flex-1">
          <Button variant="outline" className="w-full border-[#454850] text-gray-300 hover:bg-[#353840]">
